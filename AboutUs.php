...
.topic_bus{
  ...
  <body>
        ...
        <div class="about-intro">
            ...
            <p>At [EZBUS Booking Site], we make bus travel easy and convenient. We're a one-stop shop for all your bus booking needs, offering a wide selection of bus operators, routes, and schedules to choose from. Whether you're traveling for business or pleasure, we have the perfect bus ticket for you.

We're committed to providing our customers with the best possible bus booking experience. That's why we offer a number of features and benefits that make it easy to find, book, and manage your bus tickets.</p>
        </div>
    </div>
